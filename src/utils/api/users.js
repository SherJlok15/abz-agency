...
export default {
  ...
  getPositions: () => axios.get('https://frontend-test-assignment-api.abz.agency/api/v1/positions'),
  postUser: (data, token) => axios.post('https://frontend-test-assignment-api.abz.agency/api/v1/users', data, {
    headers: { Token: token }
  }),
